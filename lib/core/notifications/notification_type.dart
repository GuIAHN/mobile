...
enum NotificationType {
  ...
  Color get backgroundColor {
    switch (this) {
      case NotificationType.error:   return AppColors.errorLight;
      case NotificationType.success: return AppColors.successLight;
      case NotificationType.info:    return AppColors.infoLight;
      case NotificationType.warning: return AppColors.warningLight;
    }
  }
  ...
  Duration get defaultDuration {
    switch (this) {
      case NotificationType.error:   return const Duration(seconds: 5);
      case NotificationType.success: return const Duration(seconds: 3);
      case NotificationType.info:    return const Duration(seconds: 4);
      case NotificationType.warning: return const Duration(seconds: 4);
    }
  }
  ...
  String get label {
    switch (this) {
      ...
      case NotificationType.success: return 'Éxito';
      case NotificationType.info:    return 'Información';
