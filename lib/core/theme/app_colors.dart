...
abstract class AppColors {
  ...
  static const Color primaryMuted =
      Color(0xFFFDE8DA); // naranja muy suave (fondo)
  ...
  static const Color tertiaryMuted =
      Color(0xFFDBEAFE); // azul muy suave (fondo)
  ...
  static const Color celeste = Color(
      0xFF0891B2); // iconos ≥24px, bordes, indicadores (3.68:1 sobre blanco)
  static const Color celesteInk =
      Color(0xFF0E7490); // texto e iconos <24px (5.36:1 sobre blanco)
  static const Color celesteMuted =
      Color(0xFFE0F7FC); // fondo de chips y badges
  ...
  static const Color successInk =
      Color(0xFF15803D); // 4.57:1 sobre successLight
  static const Color warningInk =
      Color(0xFF92400E); // 6.37:1 sobre warningLight
  static const Color errorInk = Color(0xFFB91C1C); // 5.30:1 sobre errorLight
  static const Color textMeta = Color(
      0xFF6C757D); // 4.69:1 sobre blanco — timestamps/metadata (reemplaza textDisabled, que da 2.07:1)
  ...
  static const Color loginOnSurface =
      Color(0xFF1A1C1E); // secondary (texto oscuro)
