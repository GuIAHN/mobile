            ...
            return Row(
              children: [
                const CircleAvatar(
                  ...
                  radius: 18,
                  child: Icon(Icons.storefront_rounded, color: AppColors.textSecondary, size: 18),
                ),
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        conv.hasQuote ? conv.formattedPrice : 'Cotización pendiente',
                        style: GoogleFonts.hankenGrotesk(
                          fontSize: 11.5,
                          fontWeight: FontWeight.w700,
                          color: conv.hasQuote ? AppColors.success : AppColors.textSecondary,
                        ),
                      ),
                    ],
                  ),
