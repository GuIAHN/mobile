...
class _CategorySubcategorySelectorSheetState
  ...
  Widget build(BuildContext context) {
    if (_selectedCategory == null) {
      ...
      return _buildSheetLayout(
        ...
        otroLabel: 'Otro / no encuentro mi categoría',
      ...
      return _buildSheetLayout(
        ...
        showBackButton: true,
        otroLabel: 'Otro / no encuentro esta subcategoría',
        onBackPressed: () {
          setState(() {
            _selectedCategory = null;
            _filtro = '';
  ...
  Widget _buildSheetLayout({
    ...
    required VoidCallback onOtroSelected,
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
                    ...
                    return ListTile(
                      ...
                      title: Text(
                        ...
                        style: GoogleFonts.hankenGrotesk(
                          fontSize: 15,
                          fontWeight:
                              isActivo ? FontWeight.w800 : FontWeight.w500,
                          color: isActivo
                              ? AppColors.primary
                              : AppColors.textPrimary,
                        ),
          ...
          const SizedBox(height: 12),
          // Botón fijo "Otro": siempre visible, no depende de la búsqueda.
          Semantics(
            button: true,
            label: otroLabel,
            child: Material(
