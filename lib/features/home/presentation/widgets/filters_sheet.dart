...
class _FiltersSheetState extends ConsumerState<FiltersSheet> {
  ...
  Widget _buildSpecialtyChips() {
    ...
    return specialtiesAsync.when(
      data: (specialties) {
        ...
        return Wrap(
          ...
          children: specialties.map((specialty) {
            final isSelected = _tempFilters.specialtyIds.contains(specialty.id);
            return AppChip(
      ...
      error: (_, __) =>
          Text('Error al cargar especialidades', style: AppTypography.bodySm),
    );
  }
