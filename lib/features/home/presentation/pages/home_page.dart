...
import '../widgets/spare_part_wizard/spare_part_wizard_page.dart';
  ...
  Widget _buildBody(ServiceType selectedType) {
    ...
    return ListView(
      ...
      children: [
        ...
        // Si es repuestos, mostramos el CTA para abrir el Wizard
        if (isSpareParts)
          Padding(
            padding: const EdgeInsets.symmetric(horizontal: 20, vertical: 12),
            child: GestureDetector(
              onTap: () {
                SparePartWizardPage.show(context, onSubmitted: () {
