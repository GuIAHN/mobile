...
void main() {
  testWidgets('updates only when a message belongs to the card conversation',
    ...
    expect(find.text('Mensaje anterior'), findsOneWidget);
    ...
    expect(find.text('Mensaje anterior'), findsNothing);
    expect(find.text('La pieza ya está disponible'), findsOneWidget);
    expect(
